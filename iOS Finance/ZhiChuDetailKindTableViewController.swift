//
//  ZhiChuDetailKindTableViewController.swift
//  iOS Finance
//
...
class ZhiChuDetailKindTableViewController: UITableViewController,UIGestureRecognizerDelegate{
    ...
    func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "SaveSelectedZhichuDetail" {
