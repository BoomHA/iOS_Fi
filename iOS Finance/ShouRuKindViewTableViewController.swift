//
//  ShouRuKindViewTableViewController.swift
//  iOS Finance
//
...
class ShouRuKindViewTableViewController: UITableViewController,UIGestureRecognizerDelegate{
    ...
    func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "SaveSelectedShouru" {
